...
");
            ...
            if (!isReadOnly && TryCreateSerializationMethod(bodySource, fields, syntaxProvider))
            {
...
");
        ...
        private bool TryCreateSerializationMethod(StringBuilder builder, List<Field> fields, SyntaxProvider syntaxProvider)
        {
        ...
        private bool TryCreateDeserializationMethod(StringBuilder builder, string className, List<Field> fields, SyntaxProvider syntaxProvider)
        {

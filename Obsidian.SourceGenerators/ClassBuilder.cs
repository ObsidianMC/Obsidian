...
internal static class ClassBuilder
{
        ...
        switch (element.ValueKind)
        {
            ...
            case JsonValueKind.Number:
                {
                    ...
                    {
                        builder.AppendNumberProperty(elementName, element, numberTypeName);
                        break;
                    }
            ...
            case JsonValueKind.Array:
                ...
                foreach (var arrayItem in element.EnumerateArray())
                    builder.AppendArrayItem(baseFeatureTypes, arrayItem, arrayElementType);
            ...
            default:
                {
                    if (builder.TryAppendTypeProperty(baseFeatureTypes, elementName, element))
                        break;
    ...
    {
        public bool TryAppendTypeProperty(BaseFeatureDictionary baseFeatureTypes, string? elementName, JsonElement element)
        {
        ...
        public bool TryAppendStateProperty(string? elementName, JsonElement element, bool isDictionary = false)
        {
        ...
        public void AppendArrayItem(BaseFeatureDictionary baseFeatureTypes, JsonElement element, ITypeSymbol? arrayType = null)
        {
            switch (element.ValueKind)
            {
                case JsonValueKind.String:
                ...
                case JsonValueKind.Array:
                    ...
                    foreach (var arrayItem in element.EnumerateArray())
                        builder.AppendArrayItem(baseFeatureTypes, arrayItem);
                ...
                default:
                    {
                        if (builder.TryAppendTypeProperty(baseFeatureTypes, null, element))
                            break;
                        if (builder.TryAppendStateProperty(null, element))
                            break;
        ...
        public void AppendNumberProperty(string elementName, JsonElement element, string numberType = "Int32")
        {

...
internal static class Constants
{
    ...
    public const string DensityFunctionAttributeName = "DensityFunctionAttribute";
    public const string DensityFunctionCleanedAttributeName = "DensityFunction";

    public const string SurfaceRuleAttributeName = "SurfaceRuleAttribute";
    public const string SurfaceRuleCleanedAttributeName = "SurfaceRule";

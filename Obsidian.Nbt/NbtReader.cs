...
namespace Obsidian.Nbt
{
    ...
    public class NbtReader
    {
        ...
        public NbtReader([NotNull] Stream stream) : this(stream, true) { }
        ...
        public NbtTagType TagType { get; private set; } = NbtTagType.Unknown;
        ...
        public bool ReadToFollowing()
        {
            switch (state)
            {
                case NbtParseState.AtStreamBeginning:
                    ...
                    this.TagType = reader.ReadTagType();

                    if (this.TagType == NbtTagType.End)
                        return false;

                    // make sure it's a compound
        ...
        public object ReadValue()
        {
            ...
            switch (TagType)
            {
                ...
                default:
                    throw new NotImplementedException($"{TagType}");
            }

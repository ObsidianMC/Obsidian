...
namespace Obsidian.Nbt.Tags
{
    ...
    public sealed class NbtList : NbtTag, IList<NbtTag>, IList
    {
        ...
        #endregion Implementation of IEnumerable<NBtTag> and IEnumerable
        ...
        #endregion Implementation of IList<NbtTag> and ICollection<NbtTag>
        ...
        #endregion Implementation of IList and ICollection

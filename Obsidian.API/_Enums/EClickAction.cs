namespace Obsidian.API
{
    public enum EClickAction
    {
        ...
        /// <summary>
        /// Opens the file at <c>value</c> on the user's computer. This is used in messages automatically generated by the game (e.g., on taking a screenshot) and cannot be used by players for security reasons.
        /// </summary>
        OpenFile,

...
Obsidian is a C# implementation of the Minecraft server protocol. It runs on the .NET 5 Framework.

Obsidian is currently still in development, and a lot of love and care is being put into the project!

...
namespace Obsidian.Plugins
{
    public class PluginManager_
    {
        ...
        public PluginManager_() : this(null, null)
        {
        }

        public PluginManager_(object eventSource) : this(eventSource, null)
        {
        }

        public PluginManager_(object eventSource, ILogger logger)
        {
            this.logger = logger;

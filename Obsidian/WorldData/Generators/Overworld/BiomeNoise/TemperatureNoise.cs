        ...
        private Module Rivers()
        {
            return new Cache
            {
                Source0 = new Curve
                {
                    ...
                    {
                        new Curve.ControlPoint(-3.000 - settings.BiomeTemperatureRatio, -1.000),
                        new Curve.ControlPoint(-0.350 - settings.BiomeTemperatureRatio, -1.000),
                        new Curve.ControlPoint(-0.345 - settings.BiomeTemperatureRatio,  1.000),
                        new Curve.ControlPoint(-0.320 - settings.BiomeTemperatureRatio,  1.000),
                        new Curve.ControlPoint(-0.315 - settings.BiomeTemperatureRatio, -1.000),
                        new Curve.ControlPoint( 0.315 - settings.BiomeTemperatureRatio, -1.000),
                        new Curve.ControlPoint( 0.320 - settings.BiomeTemperatureRatio,  1.000),
                        new Curve.ControlPoint( 0.345 - settings.BiomeTemperatureRatio,  1.000),
                        new Curve.ControlPoint( 0.350 - settings.BiomeTemperatureRatio, -1.000),

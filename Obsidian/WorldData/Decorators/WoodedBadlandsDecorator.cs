...
public class WoodedBadlandsDecorator : BaseDecorator
{
    ...
    {
        Features.Trees.Add(new DecoratorFeatures.TreeInfo(2, TreeFeatureRegistry.MinecraftOak));
        Features.Trees.Add(new DecoratorFeatures.TreeInfo(7, TreeFeatureRegistry.MinecraftDarkOak));
    }

...
//TODO finish this
public partial class PlayerChatMessage : IClientboundPacket
{
    [Field(0)]
    ...
    public PlayerChatMessage(ChatMessage message, MessageType type) : this(message, type, Guid.Empty)
    {
    }

    public PlayerChatMessage(ChatMessage message, MessageType type, Guid sender)
    {
        Message = message;
        Type = type;
        Sender = sender;

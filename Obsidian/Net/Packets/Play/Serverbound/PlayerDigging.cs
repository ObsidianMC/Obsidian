...
public partial class PlayerDigging : IServerboundPacket
{
    ...
    {
        Block? b = server.World.GetBlockAsync(Position);
        ...
        {
            server.World.SetBlockUntrackedAsync(Position, Block.Air, true);
        ...
        {
            server.World.BlockUpdateNeighborsAsync(new BlockUpdate(server.World, Position));
        }
    }
}
